...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |-----+-----+------+-----+------+-----+-----+-----+-----+-----+-----+-----+-----+------|
   * | Ctrl| Alt |Adjust|Lower| LGUI |Space| ESC |Enter| GUI |Space|LEFT |Down |  Up |Right |
   * `--------------------------------------------------------------------------------------'
   */
  [_QWERTY] = LAYOUT( \
      ...
      KC_LCTL, KC_LALT, ADJUST,  LOWER,   KC_LGUI, KC_BSPC, KC_ESC,  KC_SPC,  KC_ENT,  KC_RGUI, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT \
      ),
  ...
  [_LOWER] = LAYOUT( \
      ...
      KC_TILD, KC_F1, KC_F2,   KC_HASH, KC_DLR,  KC_PERC,                   KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, _______, \
